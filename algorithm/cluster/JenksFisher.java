...
public class JenksFisher {
    ...
    private List<de.pschoepf.naturalbreaks.ValueCountPair> cumulValues;
     ...
     */
    public JenksFisher(List<de.pschoepf.naturalbreaks.ValueCountPair> vcpc, int k) {
        ...
        de.pschoepf.naturalbreaks.ValueCountPair currPair;
        ...
        for (int i = 0; i != this.numValues; ++i) {
            ...
            this.cumulValues.add(new de.pschoepf.naturalbreaks.ValueCountPair(cwv, cw));
     ...
     */
    public static double[] classifyJenksFisherFromValueCountPairs(int k, List<de.pschoepf.naturalbreaks.ValueCountPair> vcpc){
    ...
    public static List<Double> createJenksFisherBreaksArray(List<Double> values, int k){
        List<de.pschoepf.naturalbreaks.ValueCountPair>sortedUniqueValueCounts = getValueCountPairs(values);
        ...
        if (sortedUniqueValueCounts.size()>k){
            ...
            int i=0;
            for (de.pschoepf.naturalbreaks.ValueCountPair vcp : sortedUniqueValueCounts) {
     ...
     */
    private static List<de.pschoepf.naturalbreaks.ValueCountPair> getValueCountPairs(List<Double> values) {
        List<de.pschoepf.naturalbreaks.ValueCountPair> result = new ArrayList<>();
        HashMap<Double, de.pschoepf.naturalbreaks.ValueCountPair> vcpMap = new HashMap<>();
        for (double value : values) {
            if (!vcpMap.containsKey(value)) {
                de.pschoepf.naturalbreaks.ValueCountPair vcp = new de.pschoepf.naturalbreaks.ValueCountPair(value, 1);
        ...
        Collections.sort(result, new Comparator<de.pschoepf.naturalbreaks.ValueCountPair>(){
            @Override
